    ...
    <div class="dashboard">
        <div class="dashMenu">
            ...
            <div class="linkss">
                ...
                <RouterLink to="/dashboard/addCategories" class="sideMenuLinks active">Add Categories</RouterLink>
        ...
        <div class="addProducts">
            ...
            <div class="formAndPreview">
                <form @submit.prevent="submitForm" enctype="multipart/form-data">
                    ...
                    <input type="text" name="name" required id="title" v-model="FormData.name" placeholder="Please Enter Category Name">
...
mounted() {
    ...
    methods: {
        submitForm(){
            let token = this.$store.state.token
            axios.defaults.headers.common['Authorization'] = `Bearer ${token}`
            let res = axios.post("http://127.0.0.1:8000/api/category",this.FormData,{
      headers: {
