<template>
    ...
    <div class="Women">
        <div class="categories d-none d-lg-flex">
            ...
            <RouterLink to="/Women" class="category active">Women</RouterLink>
...
<div class="overlay d-none" id="succesMsg">
    <div class="LoginFirst">
        ...
        <div class="products" id="details">
            <div class="card" v-if="!this.women.message" v-for="product in women.slice((currentPage - 1) * itemsPerPage , currentPage * itemsPerPage)">
            ...
            <h1 v-if="this.women.message" class="text-center">{{ women.message }}</h1>
        </div>
    </div>
    <div class="buttons">
        <hr>
...
export default {
    ...
    computed : {
        totalPages(){
            return Math.ceil(this.women.length / this.itemsPerPage)
        },
        authenticated(){
    ...
    beforeMount() {
        axios.get("http://127.0.0.1:8000/api/Women").then((response)=> {
                if(response.data.message){
                this.women = response.data;
                }
                else{
                this.women = response.data.products;
                }
            }).catch(function(error) {
                console.log(error.response.data.message);
            });
