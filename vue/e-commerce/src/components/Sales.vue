...
<div class="Men">
    <div class="categories d-none d-lg-flex">
        ...
        <RouterLink to="/sales" class="category active">Sales</RouterLink>
        <hr class="categHr">
...
<div class="overlay d-none" id="succesMsg">
    ...
    <div class="products" id="details">
        <div class="card" v-if="!this.sales.message" v-for="product in sales.slice((currentPage - 1) * itemsPerPage , currentPage * itemsPerPage)">
        ...
        <h1 v-if="this.sales.message" class="text-center m-auto">{{ sales.message }}</h1>
    </div>
</div>
<div class="buttons">
    <hr>
...
beforeMount() {
    axios.get("http://127.0.0.1:8000/api/sales").then((response)=> {
            if(response.data.message){
                this.sales = response.data;
            }
            else{
                if(response.data.products){
                    this.sales = response.data.products;
                }
            }
        })
},
